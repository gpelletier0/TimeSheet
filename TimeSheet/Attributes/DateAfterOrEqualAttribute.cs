...
public class DateAfterOrEqualAttribute : ValidationAttribute {
    private readonly string _comparisonProperty;

    public DateAfterOrEqualAttribute(string comparisonProperty, string? errorMessage = null) {
    ...
    protected override ValidationResult? IsValid(object? value, ValidationContext validationContext) {
        ...
        var isAfterOrEqual = currentValue >= (DateTime)comparisonValue;
